...
public class Program {
  public static void main(String[] args) {
    ...
    int[][] sudoku = { { 8, 0, 0, 0, 4, 7, 0, 0, 6 }, { 0, 0, 1, 0, 0, 0, 0, 5, 0 }, { 0, 0, 6, 8, 0, 0, 0, 0, 0 },
        { 0, 0, 4, 5, 0, 0, 0, 0, 9 }, { 0, 8, 0, 0, 0, 0, 0, 7, 0 }, { 6, 0, 0, 0, 0, 9, 5, 0, 0 },
        { 0, 0, 0, 0, 0, 1, 8, 0, 0 }, { 0, 3, 0, 0, 0, 0, 4, 0, 0 }, { 7, 0, 0, 6, 9, 0, 0, 0, 3 } };
